...
class Win_3 (QWidget):
    def __init__(self, intr_texto1, intr_texto2, intr_texto3):
        super().__init__()
        self.intr_texto1 = intr_texto1
        self.intr_texto2 = intr_texto2
        self.intr_texto3 = intr_texto3
        self.set_appear()
        self.initUI()
        self.connect()
        self.show()
    ...
    def next_click (self):
        self.hide()
        self.camb_pan2 = Win_4(self.intr_texto1, self.intr_texto2, self.intr_texto3)